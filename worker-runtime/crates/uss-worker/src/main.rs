...
fn default_capabilities() -> Vec<WorkerCapability> {
    vec![
        ...
        WorkerCapability {
            adapter_id: "zap-api".to_string(),
            supported_target_kinds: vec!["api".to_string(), "api_schema".to_string()],
            supported_modes: vec![
                ProtoExecutionMode::Passive as i32,
                ProtoExecutionMode::ActiveValidation as i32,
            ],
            labels: vec!["web".to_string(), "api".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
        ...
        WorkerCapability {
            ...
            supported_modes: vec![ProtoExecutionMode::ActiveValidation as i32],
            labels: vec!["network".to_string(), "web".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
        ...
        WorkerCapability {
            ...
            supported_target_kinds: vec![
                ...
                "ruby_repo".to_string(),
                "php_repo".to_string(),
                "mobile_repo".to_string(),
                "android_repo".to_string(),
                "ios_repo".to_string(),
            ],
        ...
        WorkerCapability {
            adapter_id: "mobsfscan".to_string(),
            supported_target_kinds: vec![
                "mobile_repo".to_string(),
                "android_repo".to_string(),
                "ios_repo".to_string(),
            ...
            supported_modes: vec![ProtoExecutionMode::Passive as i32],
            labels: vec!["code".to_string(), "sast".to_string(), "mobile".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
        ...
        WorkerCapability {
            ...
            supported_modes: vec![ProtoExecutionMode::Passive as i32],
            labels: vec!["code".to_string(), "sast".to_string(), "ruby".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
        ...
        WorkerCapability {
            ...
            supported_modes: vec![ProtoExecutionMode::Passive as i32],
            labels: vec!["code".to_string(), "sast".to_string(), "php".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
            adapter_id: "detect-secrets".to_string(),
            supported_target_kinds: vec![
                "repo".to_string(),
                "filesystem".to_string(),
                "go_repo".to_string(),
        ...
        WorkerCapability {
            adapter_id: "composer-audit".to_string(),
            supported_target_kinds: vec![
                "php_repo".to_string(),
                "repo".to_string(),
                "filesystem".to_string(),
            ...
            supported_modes: vec![ProtoExecutionMode::Passive as i32],
            labels: vec!["code".to_string(), "sca".to_string(), "php".to_string()],
            linux_preferred: false,
        },
        WorkerCapability {
